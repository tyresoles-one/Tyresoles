...
public sealed partial class PayrollReportService : IPayrollReportService
{
    ...
    {
        new() { Id = 1, Name = "Pay Slip", ShowNos = true, ShowRegions = true, DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf", RequiredFields="dateRange" },
        new() { Id = 2, Name = "Pay Sheet", ShowNos = true, ShowRegions = true, DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf", RequiredFields="dateRange"  },
        new() { Id = 3, Name = "Department Summary", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 4, Name = "Bank Payment Details", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 5, Name = "Pay Mode Summary", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 6, Name = "ESIC Details", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 7, Name = "Non ESIC Details", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 8, Name = "ESIC Summary", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        ...
        new() { Id = 10, Name = "PF Details", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 11, Name = "PF Summary", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 12, Name = "PF Exit Report", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 13, Name = "TDS Report", ShowView = true, ViewOptions = new List<string> { "Monthly", "Quarterly", "Half Yearly", "Yearly" } },
        new() { Id = 14, Name = "Prof. Tax Report", DatePreset = "thisMonth,thisQuarter, thisYear", ShowView = true, ViewOptions = new List<string> { "Monthly", "Quarterly", "Half Yearly", "Yearly" } },
        new() { Id = 15, Name = "Leave Register", DatePreset = "thisMonth,lastMonth,thisYear",ShowNos = true, ShowType = true, TypeOptions = new List<string> { "Active", "Inactive", "Terminated" } },
        new() { Id = 16, Name = "Leave Balance", DatePreset = "thisMonth,lastMonth,thisYear", ShowNos = true, ShowType = true, TypeOptions = new List<string> { "Active", "Inactive", "Terminated" } },
        ...
        new() { Id = 25, Name = "Employee Bonus", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 26, Name = "Full & Final Settlement", ShowNos = true, ShowType = true, TypeOptions = new List<string> { "Active", "Inactive", "Terminated" } },
        new() { Id = 27, Name = "Employee Head Count", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
        new() { Id = 28, Name = "Attendace Template", DatePreset = "thisMonth,lastMonth", OutputFormats = "excel", RequiredFields="dateRange"  },
        new() { Id = 29, Name = "Declared Holidays", DatePreset = "thisMonth,lastMonth", OutputFormats = "pdf,excel", RequiredFields="dateRange"  },
    };
    ...
    private async Task<(string, object?)> GetESICDetailsAsync(ITenantScope scope, SalesReportParams p, CancellationToken ct)
    {
        ...
        var rows = withEsic.Select(rec => new
        {
            ...
            NoOfDays = rec.PresentDays,
            TotalWages = rec.Basic+rec.DA,
            ESICAmount = rec.ESIC,
