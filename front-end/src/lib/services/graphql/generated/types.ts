...
export type Employee = {
  ...
  advance: Scalars['Decimal']['output'];
  advancePeriod: Maybe<Scalars['String']['output']>;
  altAddressCode: Maybe<Scalars['String']['output']>;
  altAddressEndDate: Maybe<Scalars['DateTime']['output']>;
  altAddressStartDate: Maybe<Scalars['DateTime']['output']>;
  bankAccountNo: Maybe<Scalars['String']['output']>;
  bankCode: Maybe<Scalars['String']['output']>;
  birthDate: Maybe<Scalars['DateTime']['output']>;
  bloodGroup: Scalars['Int']['output'];
  causeOfInactivityCode: Maybe<Scalars['String']['output']>;
  city: Maybe<Scalars['String']['output']>;
  claimSanctioner: Scalars['Byte']['output'];
  companyEMail: Maybe<Scalars['String']['output']>;
  costCenterCode: Maybe<Scalars['String']['output']>;
  costObjectCode: Maybe<Scalars['String']['output']>;
  countryRegionCode: Maybe<Scalars['String']['output']>;
  county: Maybe<Scalars['String']['output']>;
  daInStructure: Scalars['Byte']['output'];
  deductionAnyOther: Scalars['Decimal']['output'];
  department: Maybe<Scalars['String']['output']>;
  direct: Scalars['Byte']['output'];
  eMail: Maybe<Scalars['String']['output']>;
  ecomileProcInspector: Scalars['Byte']['output'];
  ecomileProcManager: Scalars['Byte']['output'];
  empConfirmationDate: Maybe<Scalars['DateTime']['output']>;
  empStatusUpto: Maybe<Scalars['DateTime']['output']>;
  employementStatus: Scalars['Int']['output'];
  employmentDate: Maybe<Scalars['DateTime']['output']>;
  emplymtContractCode: Maybe<Scalars['String']['output']>;
  esicExitReason: Scalars['Int']['output'];
  esicNo: Maybe<Scalars['String']['output']>;
  extension: Maybe<Scalars['String']['output']>;
  faxNo: Maybe<Scalars['String']['output']>;
  firstName: Maybe<Scalars['String']['output']>;
  forceESICDeduction: Scalars['Byte']['output'];
  freezSalaryProcessing: Scalars['Byte']['output'];
  gender: Scalars['Int']['output'];
  globalDimension1Code: Maybe<Scalars['String']['output']>;
  globalDimension2Code: Maybe<Scalars['String']['output']>;
  grade: Scalars['Int']['output'];
  gratuity: Scalars['Decimal']['output'];
  gratuityPeriod: Maybe<Scalars['String']['output']>;
  groundsForTermCode: Maybe<Scalars['String']['output']>;
  inactiveDate: Maybe<Scalars['DateTime']['output']>;
  initials: Maybe<Scalars['String']['output']>;
  jobTitle: Maybe<Scalars['String']['output']>;
  jobTitleCode: Maybe<Scalars['String']['output']>;
  lastDateModified: Maybe<Scalars['DateTime']['output']>;
  lastName: Maybe<Scalars['String']['output']>;
  lastWorkDateESIC: Maybe<Scalars['DateTime']['output']>;
  managerNo: Maybe<Scalars['String']['output']>;
  medical: Scalars['Decimal']['output'];
  medicalPeriod: Maybe<Scalars['String']['output']>;
  middleName: Maybe<Scalars['String']['output']>;
  mobilePhoneNo: Maybe<Scalars['String']['output']>;
  nameESIC: Maybe<Scalars['String']['output']>;
  namePF: Maybe<Scalars['String']['output']>;
  no: Maybe<Scalars['String']['output']>;
  noSeries: Maybe<Scalars['String']['output']>;
  notSalaried: Scalars['Byte']['output'];
  noticePay: Scalars['Decimal']['output'];
  noticePayPeriod: Maybe<Scalars['String']['output']>;
  pager: Maybe<Scalars['String']['output']>;
  panNo: Maybe<Scalars['String']['output']>;
  paymentAnyOther: Scalars['Decimal']['output'];
  pfExitDate: Maybe<Scalars['DateTime']['output']>;
  pfExitReason: Scalars['Int']['output'];
  pfNo: Maybe<Scalars['String']['output']>;
  pfNo2: Maybe<Scalars['String']['output']>;
  phoneNo: Maybe<Scalars['String']['output']>;
  picture: Maybe<Array<Scalars['Byte']['output']>>;
  postCode: Maybe<Scalars['String']['output']>;
  prodIncMultiplier: Scalars['Decimal']['output'];
  resourceNo: Maybe<Scalars['String']['output']>;
  responsibilityCenter: Maybe<Scalars['String']['output']>;
  salesTeamType: Scalars['Int']['output'];
  salespersPurchCode: Maybe<Scalars['String']['output']>;
  salutation: Maybe<Scalars['String']['output']>;
  searchName: Maybe<Scalars['String']['output']>;
  section: Maybe<Scalars['String']['output']>;
  socAccountNo: Maybe<Scalars['String']['output']>;
  socialSecurityNo: Maybe<Scalars['String']['output']>;
  societyBalance: Scalars['Decimal']['output'];
  societyBalancePeriod: Maybe<Scalars['String']['output']>;
  societyLoan: Scalars['Decimal']['output'];
  societyLoanPeriod: Maybe<Scalars['String']['output']>;
  specialToken: Maybe<Scalars['String']['output']>;
  staffLoan: Scalars['Decimal']['output'];
  staffLoanPeriod: Maybe<Scalars['String']['output']>;
  state: Maybe<Scalars['String']['output']>;
  statisticsGroupCode: Maybe<Scalars['String']['output']>;
  status: Scalars['Int']['output'];
  stopAttBonus: Scalars['Byte']['output'];
  stopAutoCorrectName: Scalars['Byte']['output'];
  stopEPS: Scalars['Byte']['output'];
  stopESICDeduction: Scalars['Byte']['output'];
  stopLWF: Scalars['Byte']['output'];
  stopPFDeduction: Scalars['Byte']['output'];
  stopPTDeduction: Scalars['Byte']['output'];
  stopProdInc: Scalars['Byte']['output'];
  tds: Scalars['Decimal']['output'];
  tdsPeriod: Maybe<Scalars['String']['output']>;
  terminationDate: Maybe<Scalars['DateTime']['output']>;
  title: Maybe<Scalars['String']['output']>;
  uanNo: Maybe<Scalars['String']['output']>;
  unionCode: Maybe<Scalars['String']['output']>;
  unionMembershipNo: Maybe<Scalars['String']['output']>;
};
...
export type EmployeeFilterInput = {
  ...
  advance?: InputMaybe<DecimalOperationFilterInput>;
  advancePeriod?: InputMaybe<StringOperationFilterInput>;
  altAddressCode?: InputMaybe<StringOperationFilterInput>;
  altAddressEndDate?: InputMaybe<DateTimeOperationFilterInput>;
  altAddressStartDate?: InputMaybe<DateTimeOperationFilterInput>;
  ...
  bloodGroup?: InputMaybe<IntOperationFilterInput>;
  causeOfInactivityCode?: InputMaybe<StringOperationFilterInput>;
  city?: InputMaybe<StringOperationFilterInput>;
  claimSanctioner?: InputMaybe<ByteOperationFilterInput>;
  companyEMail?: InputMaybe<StringOperationFilterInput>;
  costCenterCode?: InputMaybe<StringOperationFilterInput>;
  costObjectCode?: InputMaybe<StringOperationFilterInput>;
  countryRegionCode?: InputMaybe<StringOperationFilterInput>;
  county?: InputMaybe<StringOperationFilterInput>;
  daInStructure?: InputMaybe<ByteOperationFilterInput>;
  deductionAnyOther?: InputMaybe<DecimalOperationFilterInput>;
  department?: InputMaybe<StringOperationFilterInput>;
  direct?: InputMaybe<ByteOperationFilterInput>;
  eMail?: InputMaybe<StringOperationFilterInput>;
  ecomileProcInspector?: InputMaybe<ByteOperationFilterInput>;
  ecomileProcManager?: InputMaybe<ByteOperationFilterInput>;
  empConfirmationDate?: InputMaybe<DateTimeOperationFilterInput>;
  empStatusUpto?: InputMaybe<DateTimeOperationFilterInput>;
  employementStatus?: InputMaybe<IntOperationFilterInput>;
  employmentDate?: InputMaybe<DateTimeOperationFilterInput>;
  emplymtContractCode?: InputMaybe<StringOperationFilterInput>;
  esicExitReason?: InputMaybe<IntOperationFilterInput>;
  esicNo?: InputMaybe<StringOperationFilterInput>;
  extension?: InputMaybe<StringOperationFilterInput>;
  faxNo?: InputMaybe<StringOperationFilterInput>;
  firstName?: InputMaybe<StringOperationFilterInput>;
  forceESICDeduction?: InputMaybe<ByteOperationFilterInput>;
  freezSalaryProcessing?: InputMaybe<ByteOperationFilterInput>;
  gender?: InputMaybe<IntOperationFilterInput>;
  globalDimension1Code?: InputMaybe<StringOperationFilterInput>;
  globalDimension2Code?: InputMaybe<StringOperationFilterInput>;
  grade?: InputMaybe<IntOperationFilterInput>;
  gratuity?: InputMaybe<DecimalOperationFilterInput>;
  gratuityPeriod?: InputMaybe<StringOperationFilterInput>;
  groundsForTermCode?: InputMaybe<StringOperationFilterInput>;
  inactiveDate?: InputMaybe<DateTimeOperationFilterInput>;
  initials?: InputMaybe<StringOperationFilterInput>;
  jobTitle?: InputMaybe<StringOperationFilterInput>;
  jobTitleCode?: InputMaybe<StringOperationFilterInput>;
  lastDateModified?: InputMaybe<DateTimeOperationFilterInput>;
  lastName?: InputMaybe<StringOperationFilterInput>;
  lastWorkDateESIC?: InputMaybe<DateTimeOperationFilterInput>;
  managerNo?: InputMaybe<StringOperationFilterInput>;
  medical?: InputMaybe<DecimalOperationFilterInput>;
  medicalPeriod?: InputMaybe<StringOperationFilterInput>;
  middleName?: InputMaybe<StringOperationFilterInput>;
  mobilePhoneNo?: InputMaybe<StringOperationFilterInput>;
  nameESIC?: InputMaybe<StringOperationFilterInput>;
  namePF?: InputMaybe<StringOperationFilterInput>;
  no?: InputMaybe<StringOperationFilterInput>;
  noSeries?: InputMaybe<StringOperationFilterInput>;
  notSalaried?: InputMaybe<ByteOperationFilterInput>;
  noticePay?: InputMaybe<DecimalOperationFilterInput>;
  noticePayPeriod?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<EmployeeFilterInput>>;
  pager?: InputMaybe<StringOperationFilterInput>;
  panNo?: InputMaybe<StringOperationFilterInput>;
  paymentAnyOther?: InputMaybe<DecimalOperationFilterInput>;
  pfExitDate?: InputMaybe<DateTimeOperationFilterInput>;
  pfExitReason?: InputMaybe<IntOperationFilterInput>;
  pfNo?: InputMaybe<StringOperationFilterInput>;
  pfNo2?: InputMaybe<StringOperationFilterInput>;
  phoneNo?: InputMaybe<StringOperationFilterInput>;
  picture?: InputMaybe<ListByteOperationFilterInput>;
  postCode?: InputMaybe<StringOperationFilterInput>;
  prodIncMultiplier?: InputMaybe<DecimalOperationFilterInput>;
  resourceNo?: InputMaybe<StringOperationFilterInput>;
  responsibilityCenter?: InputMaybe<StringOperationFilterInput>;
  salesTeamType?: InputMaybe<IntOperationFilterInput>;
  salespersPurchCode?: InputMaybe<StringOperationFilterInput>;
  salutation?: InputMaybe<StringOperationFilterInput>;
  searchName?: InputMaybe<StringOperationFilterInput>;
  section?: InputMaybe<StringOperationFilterInput>;
  socAccountNo?: InputMaybe<StringOperationFilterInput>;
  socialSecurityNo?: InputMaybe<StringOperationFilterInput>;
  societyBalance?: InputMaybe<DecimalOperationFilterInput>;
  societyBalancePeriod?: InputMaybe<StringOperationFilterInput>;
  societyLoan?: InputMaybe<DecimalOperationFilterInput>;
  societyLoanPeriod?: InputMaybe<StringOperationFilterInput>;
  specialToken?: InputMaybe<StringOperationFilterInput>;
  staffLoan?: InputMaybe<DecimalOperationFilterInput>;
  staffLoanPeriod?: InputMaybe<StringOperationFilterInput>;
  state?: InputMaybe<StringOperationFilterInput>;
  statisticsGroupCode?: InputMaybe<StringOperationFilterInput>;
  status?: InputMaybe<IntOperationFilterInput>;
  stopAttBonus?: InputMaybe<ByteOperationFilterInput>;
  stopAutoCorrectName?: InputMaybe<ByteOperationFilterInput>;
  stopEPS?: InputMaybe<ByteOperationFilterInput>;
  stopESICDeduction?: InputMaybe<ByteOperationFilterInput>;
  stopLWF?: InputMaybe<ByteOperationFilterInput>;
  stopPFDeduction?: InputMaybe<ByteOperationFilterInput>;
  stopPTDeduction?: InputMaybe<ByteOperationFilterInput>;
  stopProdInc?: InputMaybe<ByteOperationFilterInput>;
  tds?: InputMaybe<DecimalOperationFilterInput>;
  tdsPeriod?: InputMaybe<StringOperationFilterInput>;
  terminationDate?: InputMaybe<DateTimeOperationFilterInput>;
  title?: InputMaybe<StringOperationFilterInput>;
  uanNo?: InputMaybe<StringOperationFilterInput>;
  unionCode?: InputMaybe<StringOperationFilterInput>;
  unionMembershipNo?: InputMaybe<StringOperationFilterInput>;
};
...
export type EmployeeSortInput = {
  ...
  advance?: InputMaybe<SortEnumType>;
  advancePeriod?: InputMaybe<SortEnumType>;
  altAddressCode?: InputMaybe<SortEnumType>;
  altAddressEndDate?: InputMaybe<SortEnumType>;
  altAddressStartDate?: InputMaybe<SortEnumType>;
  bankAccountNo?: InputMaybe<SortEnumType>;
  bankCode?: InputMaybe<SortEnumType>;
  birthDate?: InputMaybe<SortEnumType>;
  bloodGroup?: InputMaybe<SortEnumType>;
  causeOfInactivityCode?: InputMaybe<SortEnumType>;
  city?: InputMaybe<SortEnumType>;
  claimSanctioner?: InputMaybe<SortEnumType>;
  companyEMail?: InputMaybe<SortEnumType>;
  costCenterCode?: InputMaybe<SortEnumType>;
  costObjectCode?: InputMaybe<SortEnumType>;
  countryRegionCode?: InputMaybe<SortEnumType>;
  county?: InputMaybe<SortEnumType>;
  daInStructure?: InputMaybe<SortEnumType>;
  deductionAnyOther?: InputMaybe<SortEnumType>;
  department?: InputMaybe<SortEnumType>;
  direct?: InputMaybe<SortEnumType>;
  eMail?: InputMaybe<SortEnumType>;
  ecomileProcInspector?: InputMaybe<SortEnumType>;
  ecomileProcManager?: InputMaybe<SortEnumType>;
  empConfirmationDate?: InputMaybe<SortEnumType>;
  empStatusUpto?: InputMaybe<SortEnumType>;
  employementStatus?: InputMaybe<SortEnumType>;
  employmentDate?: InputMaybe<SortEnumType>;
  emplymtContractCode?: InputMaybe<SortEnumType>;
  esicExitReason?: InputMaybe<SortEnumType>;
  esicNo?: InputMaybe<SortEnumType>;
  extension?: InputMaybe<SortEnumType>;
  faxNo?: InputMaybe<SortEnumType>;
  firstName?: InputMaybe<SortEnumType>;
  forceESICDeduction?: InputMaybe<SortEnumType>;
  freezSalaryProcessing?: InputMaybe<SortEnumType>;
  gender?: InputMaybe<SortEnumType>;
  globalDimension1Code?: InputMaybe<SortEnumType>;
  globalDimension2Code?: InputMaybe<SortEnumType>;
  grade?: InputMaybe<SortEnumType>;
  gratuity?: InputMaybe<SortEnumType>;
  gratuityPeriod?: InputMaybe<SortEnumType>;
  groundsForTermCode?: InputMaybe<SortEnumType>;
  inactiveDate?: InputMaybe<SortEnumType>;
  initials?: InputMaybe<SortEnumType>;
  jobTitle?: InputMaybe<SortEnumType>;
  jobTitleCode?: InputMaybe<SortEnumType>;
  lastDateModified?: InputMaybe<SortEnumType>;
  lastName?: InputMaybe<SortEnumType>;
  lastWorkDateESIC?: InputMaybe<SortEnumType>;
  managerNo?: InputMaybe<SortEnumType>;
  medical?: InputMaybe<SortEnumType>;
  medicalPeriod?: InputMaybe<SortEnumType>;
  middleName?: InputMaybe<SortEnumType>;
  mobilePhoneNo?: InputMaybe<SortEnumType>;
  nameESIC?: InputMaybe<SortEnumType>;
  namePF?: InputMaybe<SortEnumType>;
  no?: InputMaybe<SortEnumType>;
  noSeries?: InputMaybe<SortEnumType>;
  notSalaried?: InputMaybe<SortEnumType>;
  noticePay?: InputMaybe<SortEnumType>;
  noticePayPeriod?: InputMaybe<SortEnumType>;
  pager?: InputMaybe<SortEnumType>;
  panNo?: InputMaybe<SortEnumType>;
  paymentAnyOther?: InputMaybe<SortEnumType>;
  pfExitDate?: InputMaybe<SortEnumType>;
  pfExitReason?: InputMaybe<SortEnumType>;
  pfNo?: InputMaybe<SortEnumType>;
  pfNo2?: InputMaybe<SortEnumType>;
  phoneNo?: InputMaybe<SortEnumType>;
  postCode?: InputMaybe<SortEnumType>;
  prodIncMultiplier?: InputMaybe<SortEnumType>;
  resourceNo?: InputMaybe<SortEnumType>;
  responsibilityCenter?: InputMaybe<SortEnumType>;
  salesTeamType?: InputMaybe<SortEnumType>;
  salespersPurchCode?: InputMaybe<SortEnumType>;
  salutation?: InputMaybe<SortEnumType>;
  searchName?: InputMaybe<SortEnumType>;
  section?: InputMaybe<SortEnumType>;
  socAccountNo?: InputMaybe<SortEnumType>;
  socialSecurityNo?: InputMaybe<SortEnumType>;
  societyBalance?: InputMaybe<SortEnumType>;
  societyBalancePeriod?: InputMaybe<SortEnumType>;
  societyLoan?: InputMaybe<SortEnumType>;
  societyLoanPeriod?: InputMaybe<SortEnumType>;
  specialToken?: InputMaybe<SortEnumType>;
  staffLoan?: InputMaybe<SortEnumType>;
  staffLoanPeriod?: InputMaybe<SortEnumType>;
  state?: InputMaybe<SortEnumType>;
  statisticsGroupCode?: InputMaybe<SortEnumType>;
  status?: InputMaybe<SortEnumType>;
  stopAttBonus?: InputMaybe<SortEnumType>;
  stopAutoCorrectName?: InputMaybe<SortEnumType>;
  stopEPS?: InputMaybe<SortEnumType>;
  stopESICDeduction?: InputMaybe<SortEnumType>;
  stopLWF?: InputMaybe<SortEnumType>;
  stopPFDeduction?: InputMaybe<SortEnumType>;
  stopPTDeduction?: InputMaybe<SortEnumType>;
  stopProdInc?: InputMaybe<SortEnumType>;
  tds?: InputMaybe<SortEnumType>;
  tdsPeriod?: InputMaybe<SortEnumType>;
  terminationDate?: InputMaybe<SortEnumType>;
  title?: InputMaybe<SortEnumType>;
  uanNo?: InputMaybe<SortEnumType>;
  unionCode?: InputMaybe<SortEnumType>;
...
export type FaClassFilterInput = {
  and?: InputMaybe<Array<FaClassFilterInput>>;
  code?: InputMaybe<StringOperationFilterInput>;
  name?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<FaClassFilterInput>>;
};

export type FaClassSortInput = {
  code?: InputMaybe<SortEnumType>;
  name?: InputMaybe<SortEnumType>;
};

export type FaSubclass = {
  __typename: 'FASubclass';
  code: Scalars['String']['output'];
  faClassCode: Scalars['String']['output'];
  name: Scalars['String']['output'];
};

export type FaSubclassFilterInput = {
  and?: InputMaybe<Array<FaSubclassFilterInput>>;
  code?: InputMaybe<StringOperationFilterInput>;
  faClassCode?: InputMaybe<StringOperationFilterInput>;
  name?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<FaSubclassFilterInput>>;
};

export type FaSubclassSortInput = {
  code?: InputMaybe<SortEnumType>;
  faClassCode?: InputMaybe<SortEnumType>;
  name?: InputMaybe<SortEnumType>;
};

/** A connection to a list of items. */
export type FaClassesConnection = {
  __typename: 'FaClassesConnection';
  /** A list of edges. */
  edges: Maybe<Array<FaClassesEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<FaClass>>;
...
export type FaClassesEdge = {
  __typename: 'FaClassesEdge';
...
/** A connection to a list of items. */
export type FaSubclassesConnection = {
  __typename: 'FaSubclassesConnection';
  /** A list of edges. */
  edges: Maybe<Array<FaSubclassesEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<FaSubclass>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type FaSubclassesEdge = {
  __typename: 'FaSubclassesEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: FaSubclass;
...
export type FixedAsset = {
  ...
  blocked: Scalars['Byte']['output'];
  description: Scalars['String']['output'];
  description2: Scalars['String']['output'];
  faClassCode: Scalars['String']['output'];
  faSubclassCode: Scalars['String']['output'];
  no: Scalars['String']['output'];
...
export type FixedAssetFilterInput = {
  and?: InputMaybe<Array<FixedAssetFilterInput>>;
  blocked?: InputMaybe<ByteOperationFilterInput>;
  description?: InputMaybe<StringOperationFilterInput>;
  description2?: InputMaybe<StringOperationFilterInput>;
  faClassCode?: InputMaybe<StringOperationFilterInput>;
  faSubclassCode?: InputMaybe<StringOperationFilterInput>;
  no?: InputMaybe<StringOperationFilterInput>;
...
export type FixedAssetInput = {
  blocked: Scalars['Byte']['input'];
  description: Scalars['String']['input'];
  description2: Scalars['String']['input'];
  faClassCode: Scalars['String']['input'];
  faSubclassCode: Scalars['String']['input'];
...
/** A connection to a list of items. */
export type FixedAssetServiceLogsConnection = {
  __typename: 'FixedAssetServiceLogsConnection';
  /** A list of edges. */
  edges: Maybe<Array<FixedAssetServiceLogsEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<FixedAssetServiceLog>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type FixedAssetServiceLogsEdge = {
  __typename: 'FixedAssetServiceLogsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: FixedAssetServiceLog;
};

export type FixedAssetSortInput = {
  blocked?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
  description2?: InputMaybe<SortEnumType>;
  faClassCode?: InputMaybe<SortEnumType>;
  faSubclassCode?: InputMaybe<SortEnumType>;
  no?: InputMaybe<SortEnumType>;
  responsibilityCenter?: InputMaybe<SortEnumType>;
...
/** A connection to a list of items. */
export type FixedAssetsConnection = {
  __typename: 'FixedAssetsConnection';
  /** A list of edges. */
  edges: Maybe<Array<FixedAssetsEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<FixedAsset>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type FixedAssetsEdge = {
  __typename: 'FixedAssetsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: FixedAsset;
...
export type GlAccount = {
  ...
  accountType: Scalars['Int']['output'];
  blocked: Scalars['Byte']['output'];
  directPosting: Scalars['Byte']['output'];
  genBusPostingGroup: Scalars['String']['output'];
  genProdPostingGroup: Scalars['String']['output'];
  incomeBalance: Scalars['Int']['output'];
  name: Scalars['String']['output'];
  no: Scalars['String']['output'];
  vatBusPostingGroup: Scalars['String']['output'];
  vatProdPostingGroup: Scalars['String']['output'];
};

export type GlAccountFilterInput = {
  accountCategory?: InputMaybe<IntOperationFilterInput>;
  accountType?: InputMaybe<IntOperationFilterInput>;
  and?: InputMaybe<Array<GlAccountFilterInput>>;
  blocked?: InputMaybe<ByteOperationFilterInput>;
  directPosting?: InputMaybe<ByteOperationFilterInput>;
  genBusPostingGroup?: InputMaybe<StringOperationFilterInput>;
  genProdPostingGroup?: InputMaybe<StringOperationFilterInput>;
  incomeBalance?: InputMaybe<IntOperationFilterInput>;
  name?: InputMaybe<StringOperationFilterInput>;
  no?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<GlAccountFilterInput>>;
  vatBusPostingGroup?: InputMaybe<StringOperationFilterInput>;
  vatProdPostingGroup?: InputMaybe<StringOperationFilterInput>;
};

export type GlAccountSortInput = {
  accountCategory?: InputMaybe<SortEnumType>;
  accountType?: InputMaybe<SortEnumType>;
  blocked?: InputMaybe<SortEnumType>;
  directPosting?: InputMaybe<SortEnumType>;
  genBusPostingGroup?: InputMaybe<SortEnumType>;
  genProdPostingGroup?: InputMaybe<SortEnumType>;
  incomeBalance?: InputMaybe<SortEnumType>;
  name?: InputMaybe<SortEnumType>;
  no?: InputMaybe<SortEnumType>;
  vatBusPostingGroup?: InputMaybe<SortEnumType>;
...
export type GstGroupFilterInput = {
  and?: InputMaybe<Array<GstGroupFilterInput>>;
  code?: InputMaybe<StringOperationFilterInput>;
  description?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<GstGroupFilterInput>>;
};

export type GstGroupSortInput = {
  code?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
};
...
export type GenProductPostingGroupFilterInput = {
  and?: InputMaybe<Array<GenProductPostingGroupFilterInput>>;
  code?: InputMaybe<StringOperationFilterInput>;
  description?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<GenProductPostingGroupFilterInput>>;
};

export type GenProductPostingGroupSortInput = {
  code?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
};

/** A connection to a list of items. */
export type GenProductPostingGroupsConnection = {
  __typename: 'GenProductPostingGroupsConnection';
  /** A list of edges. */
  edges: Maybe<Array<GenProductPostingGroupsEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<GenProductPostingGroup>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type GenProductPostingGroupsEdge = {
  __typename: 'GenProductPostingGroupsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
...
/** A connection to a list of items. */
export type GlAccountsConnection = {
  __typename: 'GlAccountsConnection';
  /** A list of edges. */
  edges: Maybe<Array<GlAccountsEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<GlAccount>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type GlAccountsEdge = {
  __typename: 'GlAccountsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: GlAccount;
...
/** A connection to a list of items. */
export type GstGroupsConnection = {
  __typename: 'GstGroupsConnection';
  /** A list of edges. */
  edges: Maybe<Array<GstGroupsEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<GstGroup>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type GstGroupsEdge = {
  __typename: 'GstGroupsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: GstGroup;
...
export type HsnSacFilterInput = {
  and?: InputMaybe<Array<HsnSacFilterInput>>;
  code?: InputMaybe<StringOperationFilterInput>;
  description?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<HsnSacFilterInput>>;
};

export type HsnSacSortInput = {
  code?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
};

/** A connection to a list of items. */
export type HsnSacsConnection = {
  __typename: 'HsnSacsConnection';
  /** A list of edges. */
  edges: Maybe<Array<HsnSacsEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<HsnSac>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type HsnSacsEdge = {
  __typename: 'HsnSacsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: HsnSac;
...
export type InventoryPostingGroupFilterInput = {
  and?: InputMaybe<Array<InventoryPostingGroupFilterInput>>;
  code?: InputMaybe<StringOperationFilterInput>;
  description?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<InventoryPostingGroupFilterInput>>;
};

export type InventoryPostingGroupSortInput = {
  code?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
};

/** A connection to a list of items. */
export type InventoryPostingGroupsConnection = {
  __typename: 'InventoryPostingGroupsConnection';
  /** A list of edges. */
  edges: Maybe<Array<InventoryPostingGroupsEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<InventoryPostingGroup>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type InventoryPostingGroupsEdge = {
  __typename: 'InventoryPostingGroupsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
...
export type Item = {
  __typename: 'Item';
  baseUnitOfMeasure: Scalars['String']['output'];
  description: Scalars['String']['output'];
  genProdPostingGroup: Scalars['String']['output'];
  gstGroupCode: Scalars['String']['output'];
  hsnSacCode: Scalars['String']['output'];
  inventoryPostingGroup: Scalars['String']['output'];
  itemCategoryCode: Scalars['String']['output'];
  no: Scalars['String']['output'];
  productGroupCode: Scalars['String']['output'];
};
...
export type ItemCategoriesConnection = {
  ...
  /** A list of edges. */
  edges: Maybe<Array<ItemCategoriesEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<ItemCategory>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
export type ItemCategorySortInput = {
  code?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
};
...
export type ItemFilterInput = {
  ...
  baseUnitOfMeasure?: InputMaybe<StringOperationFilterInput>;
  description?: InputMaybe<StringOperationFilterInput>;
  genProdPostingGroup?: InputMaybe<StringOperationFilterInput>;
  gstGroupCode?: InputMaybe<StringOperationFilterInput>;
  hsnSacCode?: InputMaybe<StringOperationFilterInput>;
  inventoryPostingGroup?: InputMaybe<StringOperationFilterInput>;
...
export type ItemSortInput = {
  baseUnitOfMeasure?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
  genProdPostingGroup?: InputMaybe<SortEnumType>;
  gstGroupCode?: InputMaybe<SortEnumType>;
  hsnSacCode?: InputMaybe<SortEnumType>;
  inventoryPostingGroup?: InputMaybe<SortEnumType>;
...
export type Mutation = {
  ...
  navEditApproveRequest: MutationResult;
  navEditDeleteRequestType: MutationResult;
  navEditProcessRequest: MutationResult;
  navEditRejectRequest: MutationResult;
  navEditResendNotifications: MutationResult;
  navEditSaveRequestType: MutationResult;
  navEditSubmitRequest: MutationResult;
...
export type MutationNavEditApproveRequestArgs = {
...
export type MutationNavEditDeleteRequestTypeArgs = {
  id: Scalars['Int']['input'];
};


export type MutationNavEditProcessRequestArgs = {
  adminRemark?: InputMaybe<Scalars['String']['input']>;
  requestId: Scalars['UUID']['input'];
};


export type MutationNavEditRejectRequestArgs = {
  comment?: InputMaybe<Scalars['String']['input']>;
  isApproval?: InputMaybe<Scalars['Boolean']['input']>;
  level?: InputMaybe<Scalars['Int']['input']>;
  requestId: Scalars['UUID']['input'];
};


export type MutationNavEditResendNotificationsArgs = {
  requestId: Scalars['UUID']['input'];
};


export type MutationNavEditSaveRequestTypeArgs = {
  input: NavEditRequestTypeInput;
};


export type MutationNavEditSubmitRequestArgs = {
  input: NavEditRequestInput;
};
...
export type MutationSaveFixedAssetArgs = {
...
export type NavEditApprovalDto = {
  __typename: 'NavEditApprovalDto';
...
export type NavEditRequestDto = {
  ...
  approvals: Array<NavEditApprovalDto>;
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['UUID']['output'];
  ...
  requestTypeCode: Scalars['String']['output'];
  requestTypeIcon: Maybe<Scalars['String']['output']>;
  requestTypeId: Scalars['Int']['output'];
...
export type NavEditRequestInput = {
...
export type NavEditRequestType = {
  __typename: 'NavEditRequestType';
  code: Scalars['String']['output'];
  createdAt: Scalars['DateTime']['output'];
  createdBy: Scalars['String']['output'];
  description: Maybe<Scalars['String']['output']>;
  fieldsJson: Scalars['String']['output'];
  icon: Maybe<Scalars['String']['output']>;
  id: Scalars['Int']['output'];
  isActive: Scalars['Boolean']['output'];
  name: Scalars['String']['output'];
  navPrimaryKeyColumn: Scalars['String']['output'];
  navTable: Scalars['String']['output'];
  sortOrder: Scalars['Int']['output'];
  updatedAt: Maybe<Scalars['DateTime']['output']>;
  updatedBy: Maybe<Scalars['String']['output']>;
};

export type NavEditRequestTypeInput = {
  code: Scalars['String']['input'];
  description?: InputMaybe<Scalars['String']['input']>;
  ...
  name: Scalars['String']['input'];
  navPrimaryKeyColumn: Scalars['String']['input'];
  navTable: Scalars['String']['input'];
  sortOrder: Scalars['Int']['input'];
};
...
/** A connection to a list of items. */
export type PayrollEmployeesConnection = {
  __typename: 'PayrollEmployeesConnection';
  /** A list of edges. */
  edges: Maybe<Array<PayrollEmployeesEdge>>;
  /** A flattened list of the nodes. */
...
/** An edge in a connection. */
export type PayrollEmployeesEdge = {
  __typename: 'PayrollEmployeesEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: Employee;
...
export type ProductGroupFilterInput = {
  and?: InputMaybe<Array<ProductGroupFilterInput>>;
  code?: InputMaybe<StringOperationFilterInput>;
  description?: InputMaybe<StringOperationFilterInput>;
  itemCategoryCode?: InputMaybe<StringOperationFilterInput>;
  or?: InputMaybe<Array<ProductGroupFilterInput>>;
};

export type ProductGroupSortInput = {
  code?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
  itemCategoryCode?: InputMaybe<SortEnumType>;
};
...
export type ProductGroupsConnection = {
  ...
  /** A list of edges. */
  edges: Maybe<Array<ProductGroupsEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<ProductGroup>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type ProductGroupsEdge = {
  __typename: 'ProductGroupsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: ProductGroup;
...
export type Query = {
  ...
  fixedAssetServiceLogs: Maybe<FixedAssetServiceLogsConnection>;
  fixedAssets: Maybe<FixedAssetsConnection>;
  genProductPostingGroups: Maybe<GenProductPostingGroupsConnection>;
  ...
  gstGroups: Maybe<GstGroupsConnection>;
  hsnSacs: Maybe<HsnSacsConnection>;
  inventoryPostingGroups: Maybe<InventoryPostingGroupsConnection>;
  ...
  navEditAllRequests: Array<NavEditRequestDto>;
  navEditGetRecord: Maybe<Array<KeyValueItem>>;
  navEditLookupRecords: Array<Array<KeyValueItem>>;
  navEditMyRequests: Array<NavEditRequestDto>;
  navEditNavTableColumns: Array<Scalars['String']['output']>;
  navEditNavTables: Array<Scalars['String']['output']>;
  navEditPendingApprovals: Array<NavEditRequestDto>;
  navEditRequestById: Maybe<NavEditRequestDto>;
...
export type QueryFaClassesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<FaClassSortInput>>;
  where?: InputMaybe<FaClassFilterInput>;
};


export type QueryFaSubclassesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<FaSubclassSortInput>>;
  where?: InputMaybe<FaSubclassFilterInput>;
};


export type QueryFixedAssetServiceLogsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type QueryFixedAssetsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<FixedAssetSortInput>>;
  where?: InputMaybe<FixedAssetFilterInput>;
};


export type QueryGenProductPostingGroupsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<GenProductPostingGroupSortInput>>;
  where?: InputMaybe<GenProductPostingGroupFilterInput>;
};
...
export type QueryGlAccountsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<GlAccountSortInput>>;
  where?: InputMaybe<GlAccountFilterInput>;
};
...
export type QueryGstGroupsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<GstGroupSortInput>>;
  where?: InputMaybe<GstGroupFilterInput>;
};


export type QueryHsnSacsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<HsnSacSortInput>>;
  where?: InputMaybe<HsnSacFilterInput>;
};


export type QueryInventoryPostingGroupsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<InventoryPostingGroupSortInput>>;
  where?: InputMaybe<InventoryPostingGroupFilterInput>;
};
...
export type QueryItemCategoriesArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<ItemCategorySortInput>>;
  where?: InputMaybe<ItemCategoryFilterInput>;
};
...
export type QueryNavEditAllRequestsArgs = {
  statusFilter?: InputMaybe<Scalars['Int']['input']>;
};


export type QueryNavEditGetRecordArgs = {
  recordKey: Scalars['String']['input'];
  requestTypeId: Scalars['Int']['input'];
};
...
export type QueryNavEditNavTableColumnsArgs = {
  tableName: Scalars['String']['input'];
};


export type QueryNavEditRequestByIdArgs = {
  requestId: Scalars['UUID']['input'];
};


export type QueryNavEditRequestTypeByIdArgs = {
  id: Scalars['Int']['input'];
};


export type QueryNavEditRequestTypesArgs = {
  activeOnly?: InputMaybe<Scalars['Boolean']['input']>;
};


export type QueryPayrollEmployeesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type QueryProductGroupsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<ProductGroupSortInput>>;
  where?: InputMaybe<ProductGroupFilterInput>;
};
...
export type QueryStatesArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<StateSortInput>>;
  where?: InputMaybe<StateFilterInput>;
};
...
export type ReportFetchParamInput = {
  department?: InputMaybe<Scalars['String']['input']>;
...
export type State = {
  __typename: 'State';
  branchTransferRetention: Scalars['Decimal']['output'];
  code: Maybe<Scalars['String']['output']>;
  countryRegion: Maybe<Scalars['String']['output']>;
  cstAccountSales: Maybe<Scalars['String']['output']>;
  defermentPeriod: Maybe<Scalars['String']['output']>;
  description: Maybe<Scalars['String']['output']>;
  excessCrCFAccountNo: Maybe<Scalars['String']['output']>;
  financialYear: Scalars['Byte']['output'];
  periodForDebitCreditNote: Maybe<Scalars['String']['output']>;
  specifiedPeriodForRefund: Maybe<Scalars['String']['output']>;
  stateCodeForEtdsTCS: Maybe<Scalars['String']['output']>;
  stateCodeForTIN: Maybe<Scalars['String']['output']>;
  stateCodeGSTRegNo: Maybe<Scalars['String']['output']>;
  taxAccountPurchases: Maybe<Scalars['String']['output']>;
  taxAccountSales: Maybe<Scalars['String']['output']>;
  taxPeriod: Maybe<Scalars['String']['output']>;
  vatDeferredAccountNo: Maybe<Scalars['String']['output']>;
  vatPayableAccountNo: Maybe<Scalars['String']['output']>;
  vatRefundAccountNo: Maybe<Scalars['String']['output']>;
};

export type StateFilterInput = {
  and?: InputMaybe<Array<StateFilterInput>>;
  branchTransferRetention?: InputMaybe<DecimalOperationFilterInput>;
  code?: InputMaybe<StringOperationFilterInput>;
  countryRegion?: InputMaybe<StringOperationFilterInput>;
  cstAccountSales?: InputMaybe<StringOperationFilterInput>;
  defermentPeriod?: InputMaybe<StringOperationFilterInput>;
  description?: InputMaybe<StringOperationFilterInput>;
  excessCrCFAccountNo?: InputMaybe<StringOperationFilterInput>;
  financialYear?: InputMaybe<ByteOperationFilterInput>;
  or?: InputMaybe<Array<StateFilterInput>>;
  periodForDebitCreditNote?: InputMaybe<StringOperationFilterInput>;
  specifiedPeriodForRefund?: InputMaybe<StringOperationFilterInput>;
  stateCodeForEtdsTCS?: InputMaybe<StringOperationFilterInput>;
  stateCodeForTIN?: InputMaybe<StringOperationFilterInput>;
  stateCodeGSTRegNo?: InputMaybe<StringOperationFilterInput>;
  taxAccountPurchases?: InputMaybe<StringOperationFilterInput>;
  taxAccountSales?: InputMaybe<StringOperationFilterInput>;
  taxPeriod?: InputMaybe<StringOperationFilterInput>;
  vatDeferredAccountNo?: InputMaybe<StringOperationFilterInput>;
  vatPayableAccountNo?: InputMaybe<StringOperationFilterInput>;
  vatRefundAccountNo?: InputMaybe<StringOperationFilterInput>;
};

export type StateSortInput = {
  branchTransferRetention?: InputMaybe<SortEnumType>;
  code?: InputMaybe<SortEnumType>;
  countryRegion?: InputMaybe<SortEnumType>;
  cstAccountSales?: InputMaybe<SortEnumType>;
  defermentPeriod?: InputMaybe<SortEnumType>;
  description?: InputMaybe<SortEnumType>;
  excessCrCFAccountNo?: InputMaybe<SortEnumType>;
  financialYear?: InputMaybe<SortEnumType>;
  periodForDebitCreditNote?: InputMaybe<SortEnumType>;
  specifiedPeriodForRefund?: InputMaybe<SortEnumType>;
  stateCodeForEtdsTCS?: InputMaybe<SortEnumType>;
  stateCodeForTIN?: InputMaybe<SortEnumType>;
  stateCodeGSTRegNo?: InputMaybe<SortEnumType>;
  taxAccountPurchases?: InputMaybe<SortEnumType>;
  taxAccountSales?: InputMaybe<SortEnumType>;
  taxPeriod?: InputMaybe<SortEnumType>;
  vatDeferredAccountNo?: InputMaybe<SortEnumType>;
  vatPayableAccountNo?: InputMaybe<SortEnumType>;
  vatRefundAccountNo?: InputMaybe<SortEnumType>;
};
...
export type StatesConnection = {
  ...
  /** A list of edges. */
  edges: Maybe<Array<StatesEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<State>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** A connection to a list of items. */
export type UnitOfMeasuresConnection = {
  __typename: 'UnitOfMeasuresConnection';
  /** A list of edges. */
  edges: Maybe<Array<UnitOfMeasuresEdge>>;
  /** A flattened list of the nodes. */
  nodes: Maybe<Array<UnitOfMeasure>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Identifies the total count of items in the connection. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type UnitOfMeasuresEdge = {
  __typename: 'UnitOfMeasuresEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: UnitOfMeasure;
...
export type VehicleSaveInput = {
  ...
  no: Scalars['String']['input'];
  responsibilityCenter?: InputMaybe<Scalars['String']['input']>;
  status: Scalars['Int']['input'];
};
...
export type VendorModel = {
  ...
  gstRegistrationNo: Scalars['String']['output'];
  mobileNo: Scalars['String']['output'];
  name: Scalars['String']['output'];
...
export type VendorModelInput = {
  ...
  gstRegistrationNo: Scalars['String']['input'];
  mobileNo: Scalars['String']['input'];
  name: Scalars['String']['input'];
...
export type GetSessionsQuery = { __typename: 'Query', sessions: Array<{ __typename: 'SessionInfo', sessionId: string, userId: string, userType: string, entityType: string, entityCode: string, department: string, createdAtUtc: string, expiresAtUtc: string }> };
...
export type CreateCalendarEventMutation = { __typename: 'Mutation', createCalendarEvent: { __typename: 'CalendarEventDto', id: unknown, title: string, startUtc: string, endUtc: string, eventTypeId: number | null, eventTypeName: string | null, eventTypeColor: string | null, tags: Array<{ __typename: 'EventTagDto', tagType: EventTagType, tagKey: string, displayName: string | null }>, reminders: Array<{ __typename: 'ReminderDto', id: unknown, remindAtUtc: string, channel: ReminderChannel }> } | null };
...
export type GetCalendarEventByIdQuery = { __typename: 'Query', getCalendarEventById: { __typename: 'CalendarEventDto', id: unknown, ownerUserId: string, eventTypeId: number | null, eventTypeName: string | null, eventTypeColor: string | null, title: string, description: string | null, startUtc: string, endUtc: string, isAllDay: boolean, timeZoneId: string | null, location: string | null, recurrenceRuleId: unknown | null, parentEventId: unknown | null, tags: Array<{ __typename: 'EventTagDto', tagType: EventTagType, tagKey: string, displayName: string | null }>, reminders: Array<{ __typename: 'ReminderDto', id: unknown, remindAtUtc: string, channel: ReminderChannel, isSent: boolean, snoozeUntilUtc: string | null }>, recurrence: { __typename: 'RecurrenceDto', frequency: RecurrenceFrequency, interval: number, daysOfWeek: string | null, dayOfMonth: number | null, monthOfYear: number | null, endByDate: string | null, occurrenceCount: number | null, rRule: string | null } | null } | null };
...
export type GetMyCalendarEventsQuery = { __typename: 'Query', getMyCalendarEvents: Array<{ __typename: 'CalendarEventDto', id: unknown, ownerUserId: string, eventTypeId: number | null, eventTypeName: string | null, eventTypeColor: string | null, title: string, description: string | null, startUtc: string, endUtc: string, isAllDay: boolean, timeZoneId: string | null, location: string | null, recurrenceRuleId: unknown | null, parentEventId: unknown | null, tags: Array<{ __typename: 'EventTagDto', tagType: EventTagType, tagKey: string, displayName: string | null }>, reminders: Array<{ __typename: 'ReminderDto', id: unknown, remindAtUtc: string, channel: ReminderChannel, isSent: boolean, snoozeUntilUtc: string | null }> }> };
...
export type GetUpcomingRemindersQuery = { __typename: 'Query', getUpcomingReminders: Array<{ __typename: 'CalendarEventDto', id: unknown, title: string, startUtc: string, endUtc: string, reminders: Array<{ __typename: 'ReminderDto', id: unknown, remindAtUtc: string, channel: ReminderChannel, snoozeUntilUtc: string | null }> }> };
...
export type UpdateCalendarEventMutation = { __typename: 'Mutation', updateCalendarEvent: { __typename: 'CalendarEventDto', id: unknown, title: string, startUtc: string, endUtc: string, eventTypeId: number | null, eventTypeName: string | null, tags: Array<{ __typename: 'EventTagDto', tagType: EventTagType, tagKey: string, displayName: string | null }>, reminders: Array<{ __typename: 'ReminderDto', id: unknown, remindAtUtc: string, channel: ReminderChannel }> } | null };
...
export type GetStatesQueryVariables = Exact<{
  ...
  after?: InputMaybe<Scalars['String']['input']>;
  where?: InputMaybe<StateFilterInput>;
  order?: InputMaybe<Array<StateSortInput> | StateSortInput>;
}>;


export type GetStatesQuery = { __typename: 'Query', states: { __typename: 'StatesConnection', totalCount: number, nodes: Array<{ __typename: 'State', code: string | null, description: string | null }> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: string | null } } | null };
...
export type GetMyCustomersQuery = { __typename: 'Query', myCustomers: { __typename: 'MyCustomersConnection', totalCount: number, nodes: Array<{ __typename: 'Customer', no: string | null, name: string | null, city: string | null, balance: unknown, address: string | null, address2: string | null, postCode: string | null, stateCode: string | null, areaCode: string | null, dealerCode: string | null, gstRegistrationNo: string | null, gstStatus: number, panNo: string | null, customerPriceGroup: string | null }> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: string | null } } | null };
...
export type GetDealersQueryVariables = Exact<{
  ...
  after?: InputMaybe<Scalars['String']['input']>;
  where?: InputMaybe<SalespersonPurchaserFilterInput>;
  order?: InputMaybe<Array<SalespersonPurchaserSortInput> | SalespersonPurchaserSortInput>;
}>;


export type GetDealersQuery = { __typename: 'Query', dealers: { __typename: 'MyDealersConnection', totalCount: number, items: Array<{ __typename: 'SalespersonPurchaser', code: string | null, name: string | null, depot: string | null, eMail: string | null, dealershipName: string | null, phoneNo: string | null }> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: string | null } } | null };
...
export type GetVehicleByNoQueryVariables = Exact<{
  entityType?: InputMaybe<Scalars['String']['input']>;
  entityCode?: InputMaybe<Scalars['String']['input']>;
  department?: InputMaybe<Scalars['String']['input']>;
  respCenter?: InputMaybe<Scalars['String']['input']>;
  ...
  after?: InputMaybe<Scalars['String']['input']>;
  where?: InputMaybe<VehiclesFilterInput>;
  order?: InputMaybe<Array<VehiclesSortInput> | VehiclesSortInput>;
}>;


export type GetVehicleByNoQuery = { __typename: 'Query', vehicles: { __typename: 'MyVehiclesConnection', totalCount: number, items: Array<{ __typename: 'Vehicles', no: string | null, name: string | null, mobileNo: string | null, gstNo: string | null, responsibilityCenter: string | null, lineNo: number, status: number }> | null } | null };

export type GetVehicleMasterListQueryVariables = Exact<{
  entityType?: InputMaybe<Scalars['String']['input']>;
  entityCode?: InputMaybe<Scalars['String']['input']>;
  department?: InputMaybe<Scalars['String']['input']>;
  respCenter?: InputMaybe<Scalars['String']['input']>;
...
export type GetVehicleMasterListQuery = { __typename: 'Query', vehicles: { __typename: 'MyVehiclesConnection', totalCount: number, items: Array<{ __typename: 'Vehicles', no: string | null, name: string | null, mobileNo: string | null, gstNo: string | null, responsibilityCenter: string | null, lineNo: number, status: number }> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: string | null } } | null };
...
export type GetTransactionsPageQuery = { __typename: 'Query', myTransactions: { __typename: 'MyTransactionsConnection', totalCount: number, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: string | null }, nodes: Array<{ __typename: 'AccountTransaction', date: string | null, type: number, documentNo: string, amount: unknown, customerNo: string, customerName: string, balance: unknown }> | null } | null };
...
export type GetMyTransactionsQuery = { __typename: 'Query', myTransactions: { __typename: 'MyTransactionsConnection', nodes: Array<{ __typename: 'AccountTransaction', date: string | null, type: number, documentNo: string, amount: unknown, customerNo: string, customerName: string, balance: unknown }> | null } | null };

export type NavEditRequestTypesQueryVariables = Exact<{
  activeOnly?: InputMaybe<Scalars['Boolean']['input']>;
}>;


export type NavEditRequestTypesQuery = { __typename: 'Query', navEditRequestTypes: Array<{ __typename: 'NavEditRequestType', id: number, name: string, code: string, description: string | null, icon: string | null, navTable: string, navPrimaryKeyColumn: string, fieldsJson: string, isActive: boolean, sortOrder: number }> };

export type NavEditRequestTypeByIdQueryVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type NavEditRequestTypeByIdQuery = { __typename: 'Query', navEditRequestTypeById: { __typename: 'NavEditRequestType', id: number, name: string, code: string, description: string | null, icon: string | null, navTable: string, navPrimaryKeyColumn: string, fieldsJson: string, isActive: boolean, sortOrder: number } | null };

export type NavEditLookupRecordsQueryVariables = Exact<{
  requestTypeId: Scalars['Int']['input'];
  search?: InputMaybe<Scalars['String']['input']>;
  take?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type NavEditLookupRecordsQuery = { __typename: 'Query', navEditLookupRecords: Array<Array<{ __typename: 'KeyValueItem', key: string, value: string | null }>> };

export type NavEditGetRecordQueryVariables = Exact<{
  requestTypeId: Scalars['Int']['input'];
  recordKey: Scalars['String']['input'];
}>;


export type NavEditGetRecordQuery = { __typename: 'Query', navEditGetRecord: Array<{ __typename: 'KeyValueItem', key: string, value: string | null }> | null };

export type NavEditMyRequestsQueryVariables = Exact<{ [key: string]: never; }>;


export type NavEditMyRequestsQuery = { __typename: 'Query', navEditMyRequests: Array<{ __typename: 'NavEditRequestDto', id: unknown, requestTypeId: number, requestTypeName: string, requestTypeCode: string, requestTypeIcon: string | null, recordKey: string, requestBody: string, userId: string, userFullName: string | null, status: number, statusLabel: string, remark: string | null, adminRemark: string | null, processedBy: string | null, processedAt: string | null, createdAt: string, updatedAt: string | null, approvals: Array<{ __typename: 'NavEditApprovalDto', id: unknown, level: number, role: string, roleLabel: string | null, approverUserIds: Array<string>, approvedBy: string | null, status: number, statusLabel: string, comment: string | null, actionDate: string | null }> }> };

export type NavEditAllRequestsQueryVariables = Exact<{
  statusFilter?: InputMaybe<Scalars['Int']['input']>;
}>;


export type NavEditAllRequestsQuery = { __typename: 'Query', navEditAllRequests: Array<{ __typename: 'NavEditRequestDto', id: unknown, requestTypeId: number, requestTypeName: string, requestTypeCode: string, requestTypeIcon: string | null, recordKey: string, requestBody: string, userId: string, userFullName: string | null, status: number, statusLabel: string, remark: string | null, adminRemark: string | null, processedBy: string | null, processedAt: string | null, createdAt: string, updatedAt: string | null, approvals: Array<{ __typename: 'NavEditApprovalDto', id: unknown, level: number, role: string, roleLabel: string | null, approverUserIds: Array<string>, approvedBy: string | null, status: number, statusLabel: string, comment: string | null, actionDate: string | null }> }> };

export type NavEditPendingApprovalsQueryVariables = Exact<{ [key: string]: never; }>;


export type NavEditPendingApprovalsQuery = { __typename: 'Query', navEditPendingApprovals: Array<{ __typename: 'NavEditRequestDto', id: unknown, requestTypeId: number, requestTypeName: string, requestTypeCode: string, requestTypeIcon: string | null, recordKey: string, requestBody: string, userId: string, userFullName: string | null, status: number, statusLabel: string, remark: string | null, createdAt: string, approvals: Array<{ __typename: 'NavEditApprovalDto', id: unknown, level: number, role: string, roleLabel: string | null, approverUserIds: Array<string>, approvedBy: string | null, status: number, statusLabel: string, comment: string | null, actionDate: string | null }> }> };

export type NavEditNavTablesQueryVariables = Exact<{ [key: string]: never; }>;


export type NavEditNavTablesQuery = { __typename: 'Query', navEditNavTables: Array<string> };

export type NavEditNavTableColumnsQueryVariables = Exact<{
  tableName: Scalars['String']['input'];
}>;


export type NavEditNavTableColumnsQuery = { __typename: 'Query', navEditNavTableColumns: Array<string> };

export type NavEditRequestByIdQueryVariables = Exact<{
  requestId: Scalars['UUID']['input'];
}>;


export type NavEditRequestByIdQuery = { __typename: 'Query', navEditRequestById: { __typename: 'NavEditRequestDto', id: unknown, requestTypeId: number, requestTypeName: string, requestTypeCode: string, requestTypeIcon: string | null, recordKey: string, requestBody: string, userId: string, userFullName: string | null, status: number, statusLabel: string, remark: string | null, adminRemark: string | null, processedBy: string | null, processedAt: string | null, createdAt: string, updatedAt: string | null, approvals: Array<{ __typename: 'NavEditApprovalDto', id: unknown, level: number, role: string, roleLabel: string | null, approverUserIds: Array<string>, approvedBy: string | null, status: number, statusLabel: string, comment: string | null, actionDate: string | null }> } | null };

export type NavEditSaveRequestTypeMutationVariables = Exact<{
  input: NavEditRequestTypeInput;
}>;


export type NavEditSaveRequestTypeMutation = { __typename: 'Mutation', navEditSaveRequestType: { __typename: 'MutationResult', success: boolean, message: string } };

export type NavEditDeleteRequestTypeMutationVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type NavEditDeleteRequestTypeMutation = { __typename: 'Mutation', navEditDeleteRequestType: { __typename: 'MutationResult', success: boolean, message: string } };

export type NavEditSubmitRequestMutationVariables = Exact<{
  input: NavEditRequestInput;
}>;


export type NavEditSubmitRequestMutation = { __typename: 'Mutation', navEditSubmitRequest: { __typename: 'MutationResult', success: boolean, message: string } };

export type NavEditResendNotificationsMutationVariables = Exact<{
  requestId: Scalars['UUID']['input'];
}>;


export type NavEditResendNotificationsMutation = { __typename: 'Mutation', navEditResendNotifications: { __typename: 'MutationResult', success: boolean, message: string } };

export type NavEditApproveRequestMutationVariables = Exact<{
  requestId: Scalars['UUID']['input'];
  level: Scalars['Int']['input'];
  comment?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type NavEditApproveRequestMutation = { __typename: 'Mutation', navEditApproveRequest: { __typename: 'MutationResult', success: boolean, message: string } };

export type NavEditRejectRequestMutationVariables = Exact<{
  requestId: Scalars['UUID']['input'];
  comment?: InputMaybe<Scalars['String']['input']>;
  isApproval?: InputMaybe<Scalars['Boolean']['input']>;
  level?: InputMaybe<Scalars['Int']['input']>;
...
export type NavEditRejectRequestMutation = { __typename: 'Mutation', navEditRejectRequest: { __typename: 'MutationResult', success: boolean, message: string } };

export type NavEditProcessRequestMutationVariables = Exact<{
  requestId: Scalars['UUID']['input'];
  adminRemark?: InputMaybe<Scalars['String']['input']>;
}>;


export type NavEditProcessRequestMutation = { __typename: 'Mutation', navEditProcessRequest: { __typename: 'MutationResult', success: boolean, message: string } };
...
export type GetProductionProcurementOrdersInfoQuery = { __typename: 'Query', productionProcurementOrdersInfo: Array<{ __typename: 'OrderInfo', orderNo: string, supplier: string, supplierCode: string, respCenter: string, status: number, location: string, managerCode: string, date: string, manager: string, qty: number, amount: unknown }> };
...
export type GetProductionProcurementOrderLinesQuery = { __typename: 'Query', productionProcurementOrderLines: Array<{ __typename: 'OrderLine', no: string, lineNo: number, vendorNo: string, itemNo: string, make: string, serialNo: string, amount: unknown, subMake: string, inspectorCode: string, sortNo: string, inspection: string, inspector: string }> };
...
export type GetProductionEcomileProcurementTilesQuery = { __typename: 'Query', productionEcomileProcurementTiles: Array<{ __typename: 'Tile', label: string, value: unknown, description: string }> };
...
export type GetMyVendorsQuery = { __typename: 'Query', myVendors: { __typename: 'MyVendorsConnection', totalCount: number, items: Array<{ __typename: 'Vendor', no: string | null, name: string | null, city: string | null, address: string | null, address2: string | null, postCode: string | null, stateCode: string | null, contact: string | null, gstRegistrationNo: string | null, gstStatus: number, panNo: string | null, nameOnInvoice: string | null, bankName: string | null, bankACNo: string | null, bankIFSCCode: string | null, bankBranch: string | null, groupCategory: string | null, groupDetails: string | null, ecomileProcMgr: string | null, territoryCode: string | null, phoneNo: string | null, responsibilityCenter: string | null, blocked: number, balance: unknown | null, email: string | null }> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } | null };

export type GetVendorByCodeQueryVariables = Exact<{
  code: Scalars['String']['input'];
}>;


export type GetVendorByCodeQuery = { __typename: 'Query', vendorByCode: { __typename: 'Vendor', no: string | null, name: string | null, address: string | null, address2: string | null, city: string | null, postCode: string | null, stateCode: string | null, phoneNo: string | null, territoryCode: string | null, responsibilityCenter: string | null, groupCategory: string | null, groupDetails: string | null, ecomileProcMgr: string | null, nameOnInvoice: string | null, bankName: string | null, bankIFSCCode: string | null, bankACNo: string | null, bankBranch: string | null, selfInvoice: unknown, panNo: string | null, adhaarNo: string | null, gstRegistrationNo: string | null, balance: unknown | null } };
...
export type GetProcurementOrdersQuery = { __typename: 'Query', procurementOrders: { __typename: 'ProcurementOrdersConnection', totalCount: number, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: string | null }, nodes: Array<{ __typename: 'PurchaseHeader', no: string | null, postingDate: string | null, orderDate: string | null, buyFromVendorName: string | null, buyFromVendorNo: string | null, responsibilityCenter: string | null, orderStatus: number, ecomileProcMgr: string | null }> | null } | null };
...
export const GetSessionsDocument = gql`
  ...
  sessions(userId: $userId) {
    ...
    `;
export const KillSessionDocument = gql`
  ...
  killSession(sessionId: $sessionId) {
    ...
    `;
export const KillSessionsByUserDocument = gql`
...
export const ChangePasswordDocument = gql`
    mutation ChangePassword($userId: String!, $newPassword: String!, $oldPassword: String, $securityPin: Int) {
  changePassword(
    userId: $userId
...
export const ForgotPasswordDocument = gql`
    mutation ForgotPassword($username: String!, $securityPin: Int!, $newPassword: String!) {
  forgotPassword(
    username: $username
    securityPin: $securityPin
    newPassword: $newPassword
...
export const LoginDocument = gql`
    mutation Login($username: String!, $password: String!, $platform: String) {
  login(username: $username, password: $password, platform: $platform) {
    success
    message
    token
...
export const DeleteCalendarEventDocument = gql`
    mutation DeleteCalendarEvent($eventId: UUID!) {
...
export const GetMyCalendarEventsDocument = gql`
  ...
  getMyCalendarEvents(
    ...
    `;
export const GetUpcomingRemindersDocument = gql`
...
export const UpdateCalendarEventDocument = gql`
    mutation UpdateCalendarEvent($eventId: UUID!, $input: UpdateEventInput!) {
...
export const GetStatesDocument = gql`
    query GetStates($first: Int, $after: String, $where: StateFilterInput, $order: [StateSortInput!]) {
...
export const GetMyBalanceDocument = gql`
    query GetMyBalance($entityType: String, $entityCode: String, $respCenter: String) {
  myBalance(
    ...
    `;
export const GetMyAreasDocument = gql`
    query GetMyAreas($entityType: String, $entityCode: String, $department: String, $respCenters: [String!], $first: Int, $after: String, $where: AreaFilterInput) {
  myAreas(
    entityType: $entityType
    entityCode: $entityCode
    ...
    `;
export const GetMyCustomersDocument = gql`
    query GetMyCustomers($entityType: String, $entityCode: String, $department: String, $respCenter: String, $first: Int, $after: String, $where: CustomerFilterInput) {
  myCustomers(
    entityType: $entityType
    entityCode: $entityCode
    department: $department
...
export const GetDealersDocument = gql`
    query GetDealers($entityType: String, $entityCode: String, $department: String, $respCenters: [String!], $take: Int, $after: String, $where: SalespersonPurchaserFilterInput, $order: [SalespersonPurchaserSortInput!]) {
  dealers: myDealers(
    entityType: $entityType
    entityCode: $entityCode
    department: $department
    ...
    `;
export const GetMyRegionsDocument = gql`
    query GetMyRegions($entityType: String, $entityCode: String, $department: String, $respCenters: [String!], $first: Int, $after: String, $where: TerritoryFilterInput) {
  myRegions(
    entityType: $entityType
    entityCode: $entityCode
    department: $department
    ...
    `;
export const GetVehicleByNoDocument = gql`
    query GetVehicleByNo($entityType: String, $entityCode: String, $department: String, $respCenter: String, $take: Int, $after: String, $where: VehiclesFilterInput, $order: [VehiclesSortInput!]) {
  vehicles: myVehicles(
    entityType: $entityType
    entityCode: $entityCode
    department: $department
    ...
    `;
export const GetVehicleMasterListDocument = gql`
    query GetVehicleMasterList($entityType: String, $entityCode: String, $department: String, $respCenter: String, $take: Int, $after: String, $where: VehiclesFilterInput, $order: [VehiclesSortInput!]) {
  vehicles: myVehicles(
    entityType: $entityType
    entityCode: $entityCode
    department: $department
...
export const GetTransactionsPageDocument = gql`
    query GetTransactionsPage($entityType: String, $entityCode: String, $respCenter: String, $first: Int, $after: String, $order: [AccountTransactionSortInput!]) {
  myTransactions(
    entityType: $entityType
    entityCode: $entityCode
    respCenter: $respCenter
...
export const GetMyTransactionsDocument = gql`
    query GetMyTransactions($entityType: String, $entityCode: String, $respCenter: String) {
  myTransactions(
    entityType: $entityType
    entityCode: $entityCode
    respCenter: $respCenter
    ...
    `;
export const NavEditRequestTypesDocument = gql`
  ...
  navEditRequestTypes(activeOnly: $activeOnly) {
    ...
    `;
export const NavEditRequestTypeByIdDocument = gql`
...
export const NavEditLookupRecordsDocument = gql`
  ...
  navEditLookupRecords(
    ...
    `;
export const NavEditGetRecordDocument = gql`
  ...
  navEditGetRecord(requestTypeId: $requestTypeId, recordKey: $recordKey) {
    ...
    `;
export const NavEditMyRequestsDocument = gql`
  ...
  navEditMyRequests {
    ...
    `;
export const NavEditAllRequestsDocument = gql`
  ...
  navEditAllRequests(statusFilter: $statusFilter) {
    ...
    `;
export const NavEditPendingApprovalsDocument = gql`
  ...
  navEditPendingApprovals {
    ...
    `;
export const NavEditNavTablesDocument = gql`
    query NavEditNavTables {
  navEditNavTables
}
    `;
export const NavEditNavTableColumnsDocument = gql`
    query NavEditNavTableColumns($tableName: String!) {
  navEditNavTableColumns(tableName: $tableName)
}
    `;
export const NavEditRequestByIdDocument = gql`
  ...
  navEditRequestById(requestId: $requestId) {
    ...
    `;
export const NavEditSaveRequestTypeDocument = gql`
  ...
  navEditSaveRequestType(input: $input) {
    ...
    `;
export const NavEditDeleteRequestTypeDocument = gql`
  ...
  navEditDeleteRequestType(id: $id) {
    ...
    `;
export const NavEditSubmitRequestDocument = gql`
  ...
  navEditSubmitRequest(input: $input) {
    ...
    `;
export const NavEditResendNotificationsDocument = gql`
  ...
  navEditResendNotifications(requestId: $requestId) {
    ...
    `;
export const NavEditApproveRequestDocument = gql`
...
export const NavEditRejectRequestDocument = gql`
  ...
  navEditRejectRequest(
    ...
    `;
export const NavEditProcessRequestDocument = gql`
...
export const GetProductionItemNosDocument = gql`
  ...
  productionItemNos(param: $param) {
    ...
    `;
export const GetProductionMakesDocument = gql`
    query GetProductionMakes($param: FetchParamsInput!) {
  productionMakes(param: $param) {
    code
    name
  }
}
    `;
export const GetProductionMakeSubMakeDocument = gql`
    query GetProductionMakeSubMake($param: FetchParamsInput!) {
  productionMakeSubMake(param: $param) {
    code
    name
  }
}
    `;
export const GetProductionVendorsCodeNamesDocument = gql`
    query GetProductionVendorsCodeNames($param: FetchParamsInput!) {
  productionVendorsCodeNames(param: $param) {
    code
    name
  }
}
    `;
export const GetProductionInspectorCodeNamesDocument = gql`
    query GetProductionInspectorCodeNames($param: FetchParamsInput!) {
  productionInspectorCodeNames(param: $param) {
    code
    name
  }
}
    `;
export const GetProductionProcurementInspectionDocument = gql`
    query GetProductionProcurementInspection($param: FetchParamsInput!) {
  productionProcurementInspection(param: $param) {
    code
    name
  }
}
    `;
export const GetProductionProcurementMarketsDocument = gql`
    query GetProductionProcurementMarkets($param: FetchParamsInput!) {
  productionProcurementMarkets(param: $param) {
    code
    name
  }
}
    `;
export const GetProductionVendorsDocument = gql`
    query GetProductionVendors($param: FetchParamsInput!) {
  productionVendors(param: $param) {
    no
    name
    address
    address2
    ...
    `;
export const GetProductionEcomileLastNewNumberDocument = gql`
    query GetProductionEcomileLastNewNumber($respCenter: String!) {
  productionEcomileLastNewNumber(respCenter: $respCenter)
}
    `;
export const GetProductionProcurementOrdersInfoDocument = gql`
    query GetProductionProcurementOrdersInfo($param: FetchParamsInput!) {
  productionProcurementOrdersInfo(param: $param) {
    orderNo
    supplier
    supplierCode
    respCenter
    ...
    `;
export const GetProductionProcurementOrderLinesDispatchDocument = gql`
    query GetProductionProcurementOrderLinesDispatch($param: FetchParamsInput!) {
  productionProcurementOrderLinesDispatch(param: $param) {
    orderNo
    lineNo
    no
    make
    ...
    `;
export const GetProductionProcurementOrderLinesNewNumberingDocument = gql`
    query GetProductionProcurementOrderLinesNewNumbering($param: FetchParamsInput!) {
  productionProcurementOrderLinesNewNumbering(param: $param) {
    orderNo
    lineNo
    no
    make
    ...
    `;
export const GetProductionProcurementOrderLinesDocument = gql`
    query GetProductionProcurementOrderLines($param: OrderInfoInput!) {
  productionProcurementOrderLines(param: $param) {
    no
    lineNo
    vendorNo
    itemNo
    ...
    `;
export const GetProductionProcurementDispatchOrdersDocument = gql`
    query GetProductionProcurementDispatchOrders($param: FetchParamsInput!) {
  productionProcurementDispatchOrders(param: $param) {
    no
    mobileNo
    vehicleNo
    destination
    ...
    `;
export const GetProductionProcMarketsDocument = gql`
    query GetProductionProcMarkets($param: FetchParamsInput!) {
  productionProcMarkets(param: $param)
}
    `;
export const GetProductionEcomileProcurementTilesDocument = gql`
    query GetProductionEcomileProcurementTiles($param: FetchParamsInput!) {
  productionEcomileProcurementTiles(param: $param) {
    label
    value
    description
  }
    ...
    `;
export const GetProductionShipmentOrderForMergerDocument = gql`
    query GetProductionShipmentOrderForMerger($param: FetchParamsInput!) {
  productionShipmentOrderForMerger(param: $param) {
    no
    destination
    mobileNo
    transport
    ...
    `;
export const UpdateProductionCasingDocument = gql`
    mutation UpdateProductionCasing($param: FetchParamsInput!) {
  updateProductionCasing(param: $param) {
    success
    message
  }
}
    `;
export const InsertProductionCasingItemsDocument = gql`
    mutation InsertProductionCasingItems($casingItems: [CasingItemInput!]!) {
  insertProductionCasingItems(casingItems: $casingItems) {
    success
    message
  }
}
    `;
export const UpdateProductionVendorDocument = gql`
    mutation UpdateProductionVendor($param: VendorModelInput!) {
  updateProductionVendor(param: $param) {
    success
    message
  }
}
    `;
export const CreateProductionVendorDocument = gql`
    mutation CreateProductionVendor($param: FetchParamsInput!) {
  createProductionVendor(param: $param)
}
    `;
export const NewProductionProcurementOrderDocument = gql`
    mutation NewProductionProcurementOrder($param: FetchParamsInput!) {
  newProductionProcurementOrder(param: $param)
}
    `;
export const UpdateProductionProcurementOrderDocument = gql`
    mutation UpdateProductionProcurementOrder($order: OrderInfoInput!) {
  updateProductionProcurementOrder(order: $order)
}
    `;
export const NewProductionProcShipNoDocument = gql`
    mutation NewProductionProcShipNo($param: FetchParamsInput!) {
  newProductionProcShipNo(param: $param)
}
    `;
export const GenerateProductionGrAsDocument = gql`
    mutation GenerateProductionGRAs($param: FetchParamsInput!) {
  generateProductionGRAs(param: $param)
}
    `;
export const InsertProductionProcurementOrderLineDocument = gql`
    mutation InsertProductionProcurementOrderLine($order: OrderLineInput!) {
  insertProductionProcurementOrderLine(order: $order)
}
    `;
export const UpdateProductionProcurementOrderLineDocument = gql`
    mutation UpdateProductionProcurementOrderLine($order: OrderLineInput!) {
  updateProductionProcurementOrderLine(order: $order)
}
    `;
export const UpdateProductionProcOrdLineDispatchDocument = gql`
    mutation UpdateProductionProcOrdLineDispatch($lines: [OrderLineDispatchInput!]!) {
  updateProductionProcOrdLineDispatch(lines: $lines)
}
    `;
export const UpdateProductionProcOrdLineDispatchSingleDocument = gql`
  ...
  updateProductionProcOrdLineDispatchSingle(line: $line)
    ...
    `;
export const UpdateProductionProcOrdLineReceiptDocument = gql`
    mutation UpdateProductionProcOrdLineReceipt($lines: [OrderLineDispatchInput!]!) {
  updateProductionProcOrdLineReceipt(lines: $lines)
}
    `;
export const UpdateProductionProcOrdLineRemoveDocument = gql`
    mutation UpdateProductionProcOrdLineRemove($lines: [OrderLineDispatchInput!]!) {
  updateProductionProcOrdLineRemove(lines: $lines)
}
    `;
export const UpdateProductionProcOrdLineDropDocument = gql`
    mutation UpdateProductionProcOrdLineDrop($lines: [OrderLineDispatchInput!]!) {
  updateProductionProcOrdLineDrop(lines: $lines)
}
    `;
export const DeleteProductionProcurementOrderLineDocument = gql`
    mutation DeleteProductionProcurementOrderLine($order: OrderLineInput!) {
  deleteProductionProcurementOrderLine(order: $order)
}
    `;
export const DeleteProductionProcurementOrderDocument = gql`
    mutation DeleteProductionProcurementOrder($order: OrderInfoInput!) {
  deleteProductionProcurementOrder(order: $order)
}
    `;
export const GetMyVendorsDocument = gql`
    query GetMyVendors($respCenter: String, $categories: [String!], $ecoMgr: String, $after: String, $before: String, $first: Int, $last: Int, $where: VendorFilterInput, $order: [VendorSortInput!]) {
  myVendors(
    respCenter: $respCenter
    ...
    `;
export const GetVendorByCodeDocument = gql`
    query GetVendorByCode($code: String!) {
  vendorByCode(code: $code) {
    no
    name
    address
    address2
...
export const SetProfileDocument = gql`
    mutation SetProfile($userId: String!, $input: ProfileUpdateInput!) {
  setProfile(userId: $userId, input: $input) {
    success
    message
  }
}
...
export const GetPostCodesDocument = gql`
    query GetPostCodes($first: Int, $after: String, $where: PostCodeFilterInput) {
  postCodes(first: $first, after: $after, where: $where) {
    ...
    `;
export const GetEcoprocTilesDocument = gql`
    query GetEcoprocTiles($statusPosted: Int!, $userCode: String, $userDepartment: String, $userSpecialToken: String, $respCenters: String) {
  open: procurementOrders(
    statusFilter: 0
    userCode: $userCode
    userDepartment: $userDepartment
    userSpecialToken: $userSpecialToken
    respCenters: $respCenters
  ) {
    totalCount
  }
  posted: procurementOrders(
    statusFilter: $statusPosted
    userCode: $userCode
    userDepartment: $userDepartment
    userSpecialToken: $userSpecialToken
    respCenters: $respCenters
  ...
  vendors: myVendors(categories: ["CASING PROCUREMENT"], respCenter: $respCenters) {
    ...
    `;
export const GetProcurementOrdersDocument = gql`
  ...
  procurementOrders(
    ...
    `;
export const GetProcurementOrderLinesDocument = gql`
  ...
  procurementOrderLines(
    ...
    `;
export const GetEcomileLastNewNumberDocument = gql`
    query GetEcomileLastNewNumber($respCenter: String!) {
  productionEcomileLastNewNumber(respCenter: $respCenter)
}
    `;
export const GetProcurementNewNumberingPagedDocument = gql`
    query GetProcurementNewNumberingPaged($first: Int, $after: String, $fromDate: DateTime, $toDate: DateTime, $respCenters: String, $view: String, $type: String, $nos: [String!], $where: ProcurementNewNumberingDtoFilterInput, $order: [ProcurementNewNumberingDtoSortInput!]) {
  procurementNewNumberingPaged(
    ...
    `;
export const GetRespCentersMockDocument = gql`
    query GetRespCentersMock {
  __typename
}
    `;
export const GetRespCenterMockDocument = gql`
    query GetRespCenterMock {
  __typename
}
    `;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    KillSession(variables: KillSessionMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<KillSessionMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<KillSessionMutation>({ document: KillSessionDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'KillSession', 'mutation', variables);
    },
    KillSessionsByUser(variables: KillSessionsByUserMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<KillSessionsByUserMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<KillSessionsByUserMutation>({ document: KillSessionsByUserDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'KillSessionsByUser', 'mutation', variables);
    },
    ...
    ForgotPassword(variables: ForgotPasswordMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ForgotPasswordMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ForgotPasswordMutation>({ document: ForgotPasswordDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ForgotPassword', 'mutation', variables);
    },
    ...
    GetCalendarEventById(variables: GetCalendarEventByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetCalendarEventByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCalendarEventByIdQuery>({ document: GetCalendarEventByIdDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetCalendarEventById', 'query', variables);
    },
    GetEventTypes(variables?: GetEventTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetEventTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEventTypesQuery>({ document: GetEventTypesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetEventTypes', 'query', variables);
    },
    GetMyCalendarEvents(variables: GetMyCalendarEventsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetMyCalendarEventsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMyCalendarEventsQuery>({ document: GetMyCalendarEventsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetMyCalendarEvents', 'query', variables);
    },
    GetUpcomingReminders(variables?: GetUpcomingRemindersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetUpcomingRemindersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUpcomingRemindersQuery>({ document: GetUpcomingRemindersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetUpcomingReminders', 'query', variables);
    },
    ...
    GetUnreadNotificationCount(variables?: GetUnreadNotificationCountQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetUnreadNotificationCountQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUnreadNotificationCountQuery>({ document: GetUnreadNotificationCountDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetUnreadNotificationCount', 'query', variables);
    },
    ...
    OnNotification(variables: OnNotificationSubscriptionVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<OnNotificationSubscription> {
      return withWrapper((wrappedRequestHeaders) => client.request<OnNotificationSubscription>({ document: OnNotificationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'OnNotification', 'subscription', variables);
    },
    SnoozeReminder(variables: SnoozeReminderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SnoozeReminderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SnoozeReminderMutation>({ document: SnoozeReminderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SnoozeReminder', 'mutation', variables);
    },
    ...
    GetGroupDetails(variables: GetGroupDetailsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetGroupDetailsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetGroupDetailsQuery>({ document: GetGroupDetailsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetGroupDetails', 'query', variables);
    },
    ...
    GetMyBalance(variables?: GetMyBalanceQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetMyBalanceQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMyBalanceQuery>({ document: GetMyBalanceDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetMyBalance', 'query', variables);
    },
    GetMyAreas(variables?: GetMyAreasQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetMyAreasQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMyAreasQuery>({ document: GetMyAreasDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetMyAreas', 'query', variables);
    },
    GetMyCustomers(variables?: GetMyCustomersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetMyCustomersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMyCustomersQuery>({ document: GetMyCustomersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetMyCustomers', 'query', variables);
    },
    GetDealers(variables?: GetDealersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetDealersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDealersQuery>({ document: GetDealersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetDealers', 'query', variables);
    },
    GetMyRegions(variables?: GetMyRegionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetMyRegionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMyRegionsQuery>({ document: GetMyRegionsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetMyRegions', 'query', variables);
    },
    GetVehicleByNo(variables?: GetVehicleByNoQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetVehicleByNoQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetVehicleByNoQuery>({ document: GetVehicleByNoDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetVehicleByNo', 'query', variables);
    },
    GetVehicleMasterList(variables?: GetVehicleMasterListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetVehicleMasterListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetVehicleMasterListQuery>({ document: GetVehicleMasterListDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetVehicleMasterList', 'query', variables);
    },
    GetTransactionsPage(variables?: GetTransactionsPageQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetTransactionsPageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTransactionsPageQuery>({ document: GetTransactionsPageDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetTransactionsPage', 'query', variables);
    },
    GetMyTransactions(variables?: GetMyTransactionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetMyTransactionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMyTransactionsQuery>({ document: GetMyTransactionsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetMyTransactions', 'query', variables);
    },
    NavEditRequestTypes(variables?: NavEditRequestTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditRequestTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditRequestTypesQuery>({ document: NavEditRequestTypesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditRequestTypes', 'query', variables);
    },
    NavEditRequestTypeById(variables: NavEditRequestTypeByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditRequestTypeByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditRequestTypeByIdQuery>({ document: NavEditRequestTypeByIdDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditRequestTypeById', 'query', variables);
    },
    NavEditLookupRecords(variables: NavEditLookupRecordsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditLookupRecordsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditLookupRecordsQuery>({ document: NavEditLookupRecordsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditLookupRecords', 'query', variables);
    },
    NavEditGetRecord(variables: NavEditGetRecordQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditGetRecordQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditGetRecordQuery>({ document: NavEditGetRecordDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditGetRecord', 'query', variables);
    },
    NavEditMyRequests(variables?: NavEditMyRequestsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditMyRequestsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditMyRequestsQuery>({ document: NavEditMyRequestsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditMyRequests', 'query', variables);
    },
    NavEditAllRequests(variables?: NavEditAllRequestsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditAllRequestsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditAllRequestsQuery>({ document: NavEditAllRequestsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditAllRequests', 'query', variables);
    },
    NavEditPendingApprovals(variables?: NavEditPendingApprovalsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditPendingApprovalsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditPendingApprovalsQuery>({ document: NavEditPendingApprovalsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditPendingApprovals', 'query', variables);
    },
    NavEditNavTables(variables?: NavEditNavTablesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditNavTablesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditNavTablesQuery>({ document: NavEditNavTablesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditNavTables', 'query', variables);
    },
    NavEditNavTableColumns(variables: NavEditNavTableColumnsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditNavTableColumnsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditNavTableColumnsQuery>({ document: NavEditNavTableColumnsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditNavTableColumns', 'query', variables);
    },
    NavEditRequestById(variables: NavEditRequestByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditRequestByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditRequestByIdQuery>({ document: NavEditRequestByIdDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditRequestById', 'query', variables);
    },
    NavEditSaveRequestType(variables: NavEditSaveRequestTypeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditSaveRequestTypeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditSaveRequestTypeMutation>({ document: NavEditSaveRequestTypeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditSaveRequestType', 'mutation', variables);
    },
    NavEditDeleteRequestType(variables: NavEditDeleteRequestTypeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditDeleteRequestTypeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditDeleteRequestTypeMutation>({ document: NavEditDeleteRequestTypeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditDeleteRequestType', 'mutation', variables);
    },
    NavEditSubmitRequest(variables: NavEditSubmitRequestMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditSubmitRequestMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditSubmitRequestMutation>({ document: NavEditSubmitRequestDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditSubmitRequest', 'mutation', variables);
    },
    NavEditResendNotifications(variables: NavEditResendNotificationsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditResendNotificationsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditResendNotificationsMutation>({ document: NavEditResendNotificationsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditResendNotifications', 'mutation', variables);
    },
    NavEditApproveRequest(variables: NavEditApproveRequestMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditApproveRequestMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditApproveRequestMutation>({ document: NavEditApproveRequestDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditApproveRequest', 'mutation', variables);
    },
    NavEditRejectRequest(variables: NavEditRejectRequestMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditRejectRequestMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditRejectRequestMutation>({ document: NavEditRejectRequestDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditRejectRequest', 'mutation', variables);
    },
    NavEditProcessRequest(variables: NavEditProcessRequestMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NavEditProcessRequestMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NavEditProcessRequestMutation>({ document: NavEditProcessRequestDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NavEditProcessRequest', 'mutation', variables);
    },
    GetProductionItemNos(variables: GetProductionItemNosQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionItemNosQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionItemNosQuery>({ document: GetProductionItemNosDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionItemNos', 'query', variables);
    },
    GetProductionMakes(variables: GetProductionMakesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionMakesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionMakesQuery>({ document: GetProductionMakesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionMakes', 'query', variables);
    },
    GetProductionMakeSubMake(variables: GetProductionMakeSubMakeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionMakeSubMakeQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionMakeSubMakeQuery>({ document: GetProductionMakeSubMakeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionMakeSubMake', 'query', variables);
    },
    GetProductionVendorsCodeNames(variables: GetProductionVendorsCodeNamesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionVendorsCodeNamesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionVendorsCodeNamesQuery>({ document: GetProductionVendorsCodeNamesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionVendorsCodeNames', 'query', variables);
    },
    GetProductionInspectorCodeNames(variables: GetProductionInspectorCodeNamesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionInspectorCodeNamesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionInspectorCodeNamesQuery>({ document: GetProductionInspectorCodeNamesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionInspectorCodeNames', 'query', variables);
    },
    GetProductionProcurementInspection(variables: GetProductionProcurementInspectionQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionProcurementInspectionQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionProcurementInspectionQuery>({ document: GetProductionProcurementInspectionDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionProcurementInspection', 'query', variables);
    },
    GetProductionProcurementMarkets(variables: GetProductionProcurementMarketsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionProcurementMarketsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionProcurementMarketsQuery>({ document: GetProductionProcurementMarketsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionProcurementMarkets', 'query', variables);
    },
    GetProductionVendors(variables: GetProductionVendorsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionVendorsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionVendorsQuery>({ document: GetProductionVendorsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionVendors', 'query', variables);
    },
    GetProductionEcomileLastNewNumber(variables: GetProductionEcomileLastNewNumberQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionEcomileLastNewNumberQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionEcomileLastNewNumberQuery>({ document: GetProductionEcomileLastNewNumberDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionEcomileLastNewNumber', 'query', variables);
    },
    GetProductionProcurementOrdersInfo(variables: GetProductionProcurementOrdersInfoQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionProcurementOrdersInfoQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionProcurementOrdersInfoQuery>({ document: GetProductionProcurementOrdersInfoDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionProcurementOrdersInfo', 'query', variables);
    },
    GetProductionProcurementOrderLinesDispatch(variables: GetProductionProcurementOrderLinesDispatchQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionProcurementOrderLinesDispatchQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionProcurementOrderLinesDispatchQuery>({ document: GetProductionProcurementOrderLinesDispatchDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionProcurementOrderLinesDispatch', 'query', variables);
    },
    GetProductionProcurementOrderLinesNewNumbering(variables: GetProductionProcurementOrderLinesNewNumberingQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionProcurementOrderLinesNewNumberingQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionProcurementOrderLinesNewNumberingQuery>({ document: GetProductionProcurementOrderLinesNewNumberingDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionProcurementOrderLinesNewNumbering', 'query', variables);
    },
    GetProductionProcurementOrderLines(variables: GetProductionProcurementOrderLinesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionProcurementOrderLinesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionProcurementOrderLinesQuery>({ document: GetProductionProcurementOrderLinesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionProcurementOrderLines', 'query', variables);
    },
    GetProductionProcurementDispatchOrders(variables: GetProductionProcurementDispatchOrdersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionProcurementDispatchOrdersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionProcurementDispatchOrdersQuery>({ document: GetProductionProcurementDispatchOrdersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionProcurementDispatchOrders', 'query', variables);
    },
    GetProductionProcMarkets(variables: GetProductionProcMarketsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionProcMarketsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionProcMarketsQuery>({ document: GetProductionProcMarketsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionProcMarkets', 'query', variables);
    },
    GetProductionEcomileProcurementTiles(variables: GetProductionEcomileProcurementTilesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionEcomileProcurementTilesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionEcomileProcurementTilesQuery>({ document: GetProductionEcomileProcurementTilesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionEcomileProcurementTiles', 'query', variables);
    },
    GetProductionShipmentOrderForMerger(variables: GetProductionShipmentOrderForMergerQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProductionShipmentOrderForMergerQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductionShipmentOrderForMergerQuery>({ document: GetProductionShipmentOrderForMergerDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProductionShipmentOrderForMerger', 'query', variables);
    },
    UpdateProductionCasing(variables: UpdateProductionCasingMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionCasingMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionCasingMutation>({ document: UpdateProductionCasingDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionCasing', 'mutation', variables);
    },
    InsertProductionCasingItems(variables: InsertProductionCasingItemsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<InsertProductionCasingItemsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InsertProductionCasingItemsMutation>({ document: InsertProductionCasingItemsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'InsertProductionCasingItems', 'mutation', variables);
    },
    UpdateProductionVendor(variables: UpdateProductionVendorMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionVendorMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionVendorMutation>({ document: UpdateProductionVendorDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionVendor', 'mutation', variables);
    },
    CreateProductionVendor(variables: CreateProductionVendorMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateProductionVendorMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateProductionVendorMutation>({ document: CreateProductionVendorDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateProductionVendor', 'mutation', variables);
    },
    NewProductionProcurementOrder(variables: NewProductionProcurementOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NewProductionProcurementOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NewProductionProcurementOrderMutation>({ document: NewProductionProcurementOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NewProductionProcurementOrder', 'mutation', variables);
    },
    UpdateProductionProcurementOrder(variables: UpdateProductionProcurementOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionProcurementOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionProcurementOrderMutation>({ document: UpdateProductionProcurementOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionProcurementOrder', 'mutation', variables);
    },
    NewProductionProcShipNo(variables: NewProductionProcShipNoMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NewProductionProcShipNoMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<NewProductionProcShipNoMutation>({ document: NewProductionProcShipNoDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'NewProductionProcShipNo', 'mutation', variables);
    },
    GenerateProductionGRAs(variables: GenerateProductionGrAsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GenerateProductionGrAsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<GenerateProductionGrAsMutation>({ document: GenerateProductionGrAsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GenerateProductionGRAs', 'mutation', variables);
    },
    InsertProductionProcurementOrderLine(variables: InsertProductionProcurementOrderLineMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<InsertProductionProcurementOrderLineMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InsertProductionProcurementOrderLineMutation>({ document: InsertProductionProcurementOrderLineDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'InsertProductionProcurementOrderLine', 'mutation', variables);
    },
    UpdateProductionProcurementOrderLine(variables: UpdateProductionProcurementOrderLineMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionProcurementOrderLineMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionProcurementOrderLineMutation>({ document: UpdateProductionProcurementOrderLineDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionProcurementOrderLine', 'mutation', variables);
    },
    UpdateProductionProcOrdLineDispatch(variables: UpdateProductionProcOrdLineDispatchMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionProcOrdLineDispatchMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionProcOrdLineDispatchMutation>({ document: UpdateProductionProcOrdLineDispatchDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionProcOrdLineDispatch', 'mutation', variables);
    },
    UpdateProductionProcOrdLineDispatchSingle(variables: UpdateProductionProcOrdLineDispatchSingleMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionProcOrdLineDispatchSingleMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionProcOrdLineDispatchSingleMutation>({ document: UpdateProductionProcOrdLineDispatchSingleDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionProcOrdLineDispatchSingle', 'mutation', variables);
    },
    UpdateProductionProcOrdLineReceipt(variables: UpdateProductionProcOrdLineReceiptMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionProcOrdLineReceiptMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionProcOrdLineReceiptMutation>({ document: UpdateProductionProcOrdLineReceiptDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionProcOrdLineReceipt', 'mutation', variables);
    },
    UpdateProductionProcOrdLineRemove(variables: UpdateProductionProcOrdLineRemoveMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionProcOrdLineRemoveMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionProcOrdLineRemoveMutation>({ document: UpdateProductionProcOrdLineRemoveDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionProcOrdLineRemove', 'mutation', variables);
    },
    UpdateProductionProcOrdLineDrop(variables: UpdateProductionProcOrdLineDropMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateProductionProcOrdLineDropMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateProductionProcOrdLineDropMutation>({ document: UpdateProductionProcOrdLineDropDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateProductionProcOrdLineDrop', 'mutation', variables);
    },
    DeleteProductionProcurementOrderLine(variables: DeleteProductionProcurementOrderLineMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteProductionProcurementOrderLineMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteProductionProcurementOrderLineMutation>({ document: DeleteProductionProcurementOrderLineDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteProductionProcurementOrderLine', 'mutation', variables);
    },
    DeleteProductionProcurementOrder(variables: DeleteProductionProcurementOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteProductionProcurementOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteProductionProcurementOrderMutation>({ document: DeleteProductionProcurementOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteProductionProcurementOrder', 'mutation', variables);
    },
    GetMyVendors(variables?: GetMyVendorsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetMyVendorsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMyVendorsQuery>({ document: GetMyVendorsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetMyVendors', 'query', variables);
    },
    GetVendorByCode(variables: GetVendorByCodeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetVendorByCodeQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetVendorByCodeQuery>({ document: GetVendorByCodeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetVendorByCode', 'query', variables);
    },
    ...
    SetProfile(variables: SetProfileMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SetProfileMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SetProfileMutation>({ document: SetProfileDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SetProfile', 'mutation', variables);
    },
    GetPostCodes(variables?: GetPostCodesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetPostCodesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPostCodesQuery>({ document: GetPostCodesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetPostCodes', 'query', variables);
    },
    GetEcoprocTiles(variables: GetEcoprocTilesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetEcoprocTilesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEcoprocTilesQuery>({ document: GetEcoprocTilesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetEcoprocTiles', 'query', variables);
    },
    GetProcurementOrders(variables?: GetProcurementOrdersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProcurementOrdersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProcurementOrdersQuery>({ document: GetProcurementOrdersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProcurementOrders', 'query', variables);
    },
    GetProcurementOrderLines(variables?: GetProcurementOrderLinesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProcurementOrderLinesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProcurementOrderLinesQuery>({ document: GetProcurementOrderLinesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProcurementOrderLines', 'query', variables);
    },
    GetEcomileLastNewNumber(variables: GetEcomileLastNewNumberQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetEcomileLastNewNumberQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEcomileLastNewNumberQuery>({ document: GetEcomileLastNewNumberDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetEcomileLastNewNumber', 'query', variables);
    },
    GetProcurementNewNumberingPaged(variables?: GetProcurementNewNumberingPagedQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProcurementNewNumberingPagedQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProcurementNewNumberingPagedQuery>({ document: GetProcurementNewNumberingPagedDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetProcurementNewNumberingPaged', 'query', variables);
    },
    GetRespCentersMock(variables?: GetRespCentersMockQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetRespCentersMockQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRespCentersMockQuery>({ document: GetRespCentersMockDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetRespCentersMock', 'query', variables);
    },
    GetRespCenterMock(variables?: GetRespCenterMockQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetRespCenterMockQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRespCenterMockQuery>({ document: GetRespCenterMockDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetRespCenterMock', 'query', variables);
    },
    ...
    GetEmployees(variables?: GetEmployeesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetEmployeesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEmployeesQuery>({ document: GetEmployeesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetEmployees', 'query', variables);
    },
    ...
    SaveDealer(variables: SaveDealerMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SaveDealerMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SaveDealerMutation>({ document: SaveDealerDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SaveDealer', 'mutation', variables);
    }
  };
}
