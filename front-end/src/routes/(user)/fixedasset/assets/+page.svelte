<script lang="ts">
  ...
  const columns: DataGridColumn<any>[] = [
    ...
    { accessorKey: "responsibleEmployeeInitials", header: "Assigned To" },
...
<div class="flex min-h-svh flex-col bg-background text-foreground">
  <PageHeading backHref="/fixedasset" icon="package">
